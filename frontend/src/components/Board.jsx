...
console.log(showModal)
  ...
  return (
    <main >
      <button onClick={handleClick} className="bg-[#FFFFF] w-[90vw] h-[20.5vh] text-black flex flex-col items-star rounded-3xl border-2 border-#D4D4D8 shadow-lg mt-1">
      ...
      {showModal && <BoardOptions title={props.title}  onClose={() => setShowModal(false)}/>}
