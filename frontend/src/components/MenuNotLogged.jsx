...
export const MenuNotLogged = ({render,setrender}) => {
    const [active, setactive] = useState(true);
  return (
    <div className="fixed z-40 w-[100vw] h-[100vh] flex flex-col items-end bg-black bg-opacity-25">
      <div className=" w-[50vw] h-[100vh] bg-white">
      <div className="flex flex-col items-end h-full w-auto gap-y-[4vh] mt-[2.6vh] mr-[5.5vw]">
        <button onClick={setrender(!render)} className="h-[2.8em] w-[2.8em] flex items-center justify-center border border-neutral-900 rounded-md">
          <XClose/>
        </button>
