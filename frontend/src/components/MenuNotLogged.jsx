...
export const MenuNotLogged = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      ...
      className="fixed z-50 w-[100vw] h-[100vh] flex flex-col items-end"
    >
      ...
      <div className=" w-[50vw] h-[100vh] bg-white">
        <div className="flex flex-col items-end h-full w-auto gap-y-[4vh] mt-[2.6vh] mr-[5.5vw]">
          ...
          <Link
            to={"/register"}
            className="w-2/5 h-[4.5%] flex items-center justify-center border border-[#6D28D9] text-[#6D28D9] hover:text-[#6D28D9] rounded font-['Lato','sans-serif'] font-normal"
          >
            Registro
          </Link>
          <Link
